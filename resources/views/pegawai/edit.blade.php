...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group{{ $errors->has('alamat_lengkap') ? ' has-error' : '' }}">
			...
			<div class="col-sm-10">
				<textarea name="alamat_lengkap" id="alamat_lengkap" class="form-control" rows="5">{{ $pegawai->alamat_lengkap }}</textarea>
		...
		<div class="form-group{{ $errors->has('pendidikan_teakhir') ? ' has-error' : '' }}">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="pendidikan_teakhir" name="pendidikan_teakhir" value="{{ $pegawai->pendidikan_teakhir }}" required/>
		...
		<div class="form-group{{ $errors->has('jabatan') ? ' has-error' : '' }}">
			...
			<div class="col-sm-10">
				<input type="jabatan" class="form-control" id="jabatan" name="jabatan" value="{{ $pegawai->jabatan }}" required/>
		...
		<div class="form-group{{ $errors->has('bagian') ? ' has-error' : '' }}">
			...
			<div class="col-sm-10">
				<label class="radio-inline">
					<input type="radio" name="bagian" value="DEVELOPMENT" @php echo $pegawai->bagian == "DEVELOPMENT" ? "checked" : ""; @endphp> Development
				</label>
				<label class="radio-inline">
					<input type="radio" name="bagian" value="OPERASIONAL" @php echo $pegawai->bagian == "OPERASIONAL" ? "checked" : ""; @endphp> Operational
				</label>
				<label class="radio-inline">
					<input type="radio" name="bagian" value="MARKETING_FINANCE" @php echo $pegawai->bagian == "MARKETING_FINANCE" ? "checked" : ""; @endphp> Marketing / Finance
				</label>
		...
		<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
			...
			<div class="col-sm-10">
				<label class="radio-inline">
					<input type="radio" name="status" value="TETAP" @php echo $pegawai->status == "TETAP" ? "checked" : ""; @endphp> Tetap
				</label>
				<label class="radio-inline">
					<input type="radio" name="status" value="KONTRAK" @php echo $pegawai->status == "KONTRAK" ? "checked" : ""; @endphp> Kontrak
				</label>
		...
		<div class="form-group{{ $errors->has('tanggal_gabung') ? ' has-error' : '' }}">
			...
			<div class="col-sm-10">
				<input type="date" class="form-control" id="tanggal_gabung" name="tanggal_gabung" value="{{ $pegawai->tanggal_gabung }}"  />
